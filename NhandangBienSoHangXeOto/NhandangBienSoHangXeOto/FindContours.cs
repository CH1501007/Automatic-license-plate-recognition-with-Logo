...
namespace NhandangBienSoHangXeOto
{
    ...
    {
        public int count = 0;
        /// <param name="colorImage">Anh nguon co mau.</param>
        /// <param name="thresholdValue">Gia tri su dung de phan nguong.</param>
        /// <param name="processedGray">Anh xem ket qua.</param>
        /// <param name="processedColor">Anh mau ket qua.</param>
        public int IdentifyContours(Bitmap colorImage, int thresholdValue, bool invert, out Bitmap processedGray, out Bitmap processedColor, out List<Rectangle> list)
        {
            ...
            #region tim gia tri nguong thresh de co so ky tu lon nhat
